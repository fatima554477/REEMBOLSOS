...
<img src="includes/contraer41.png" id="ocultar1" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;REEMBOLSOS</p></strong></div>
		...
		<div id="target1" style="display:block;" class="content2">
			<div class="card">
				...
				<form class="row g-3 needs-validation was-validated" novalidate="" id="pagoaproveedoresform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                 ...
                 <th scope="row"> <label  for="formFileSm"  class="form-label">ADJUNTAR FACTURA FORMATO &nbsp;<a style="color:red;font:12px">(XML)</a></a></a><BR><a style="color:red;font:12px">SI NO TIENES POR EL MOMENTO EL ARCHIVO XML, <br>PRIMERO DEBES CAPTURAR RAZÓN SOCIAL <br>Y DESPUÉS CARGAR EL PDF</a></label></th>
...
?></div>			 
           ...
           <td><input type="text" class="form-control" id="REEMBOLSO" required=""  value="REEMBOLSO" name="VIATICOSOPRO" placeholder="REEMBOLSO"  readonly="readonly"></td>
                 </tr>
      	                 <tr  style="background:#c5f58c"> 

                 <th scope="row"> <label for="validationCustom03" class="form-label">ID RELACIONADO A ESTE REEMBOLSO</label></th>
...
<BR/>
			...
			<table style="text-align:right;">
				<tr>
					<td>
						<?php if($conexion->variablespermisos('','reembolsos','guardar')=='si'){ ?>
